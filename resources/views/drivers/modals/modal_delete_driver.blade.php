<div class="modal fade" id="modal_delete_driver_{{ $item->driver_id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            {!!
            Form::open(['action'=>['DriverController@destroy',$item->driver_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
